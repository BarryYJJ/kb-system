# AI Is a 5-Layer Cake - Jensen Huang

**来源**: webpage | https://blogs.nvidia.com/blog/ai-5-layer-cake/

**类型**: webpage

**入库时间**: 2026-03-11T11:58:25.948044
...
That is the five-layer cake: Energy → chips → infrastructure → models → applications. Every successful application pulls on every layer beneath it, all the way down to the power plant that keeps it alive.
