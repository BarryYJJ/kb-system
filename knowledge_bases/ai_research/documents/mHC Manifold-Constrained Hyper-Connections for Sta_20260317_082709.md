# mHC: Manifold-Constrained Hyper-Connections for Stable Transformer Training (DeepSeek)

**来源**: PDF | https://arxiv.org/abs/2512.24880

**类型**: pdf

**入库时间**: 2026-03-17T08:27:09.948200
...
,
(6)
where 1𝑛represents the 𝑛-dimensional vector of all ones.
...
Layer 𝑙0 represents the first layer in 𝐿𝑟layers and layer 𝑙is in [𝑙0, 𝑙0 + 𝐿𝑟−1].
Activations
x𝑙0
F (Hpre
𝑙
